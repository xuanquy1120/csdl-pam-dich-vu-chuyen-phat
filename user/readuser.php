                ...
                <div class="col-md-12">
                  ...
                  ?>
                    ...
                    <div class="form-group">
                        ...
                        <strong class="form-control-static"><?php echo $row["dob"]; ?></strong>
                    </div>
                    <div class="form-group">
                        <label>Số điện thoại: </label>
                        <strong class="form-control-static"><?php echo $row["phonenumber"]; ?></strong>
                    </div>
                    <div class="form-group">
                        <label>Email: </label>
                        <strong class="form-control-static"><?php echo $row["email"]; ?></strong>
                    </div>
                    <!-- <div class="form-group">
                        <label>tên tài khoản: </label>
                        <strong class="form-control-static"><?php echo $row["username"]; ?></strong>
                    </div>
                    <div class="form-group">
                        <label>Mật khẩu: </label>
                        <strong class="form-control-static"><?php echo $row["password"]; ?></strong>
                    </div> -->
                
                    <p><a href="user.php" class="btn btn-success">Quay lại</a></p>
                    </div>
                <?php } ?>
            </div>        
        </div>
