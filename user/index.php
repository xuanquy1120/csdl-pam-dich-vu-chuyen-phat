        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
     	...
     	<?php } ?>
                    <div class="form-group">
                      <input type="name" name="username" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Hãy nhập tài khoản .. ">
                    </div>
                    <div class="form-group">
