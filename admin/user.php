...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <a class="btn btn-primary" style="margin-bottom:15px;" href="adduser.php" >Thêm tài khoản</a>
    ...
    <tbody>
      ...
      {
        $sel = 'select * from employee where name like "%'.$_GET['var'].'%"';
      }
      else
      {
    ...
    ?>
      <tr>
          ...
          <td><?php echo $row['email']; ?></td>
           ...
           <td><a onclick="return confirm('Bạn chắc chứ?')" href="deleteuser.php?id=<?php echo $row['id']; ?>"><i class="fas fa-trash-alt"></i></a></td>
           <td><a href="updateuser.php?id=<?php echo $row['id']; ?>"><i class="far fa-edit"></a></td>
           <td><a href="readuser.php?id=<?php echo $row['id']; ?>"><i class="fas fa-eye"></a></td>
